...
datetime_arrival = datetime(arrival_y, arrival_m, arrival_d,arrival_h,arrival_min,0)
datetime_wait_wp = datetime(arrival_y, arrival_m, arrival_d,arrival_h,arrival_min+5,0)
